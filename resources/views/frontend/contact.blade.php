			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							<a class="menu_tab active_tag" href="contact.html">Contact</a> </li>
...
Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat sed do eiusmod tempor incididunt ut labore dolore</p>
        <ul>
		 <li><i class="fa fa-map-marker"></i> 40, 27th Street, DB 05231, United Kingdom.</li>
