   ...
   <div class="header_top_1 clearfix">
	 ...
	 <div class="header_top_1_inner clearfix">
	    <ul class="nav_1">
					...
					<li class="dropdown tag_1">
						  <a class="tag_menu" href="#" data-toggle="dropdown" role="button" aria-expanded="false">Language<span class="caret"></span></a>
					...
					<li class="dropdown tag_1 border_none_1">
						  <a class="tag_menu" href="#" data-toggle="dropdown" role="button" aria-expanded="false">Currency<span class="caret"></span></a>
						  <ul class="dropdown-menu drop_1" role="menu">
	...
	<div class="col-sm-6">
	 <div class="header_top_1_inner clearfix text-right">
	   <ul class="nav_1">
                    <li class="tag_1"><a class="tag_menu" href="#">My Profile</a></li>
					<li class="tag_1"><a class="tag_menu" href="#">Add To Cart</a></li>
					<li class="tag_1 border_none_1"><a class="tag_menu" href="#">Leaving Time</a></li>
       </ul>
	 </div>
	</div>
   </div>
   ...
   <div class="header_middle_1 clearfix">
    <div class="col-sm-2">
	 <div class="header_middle_1_left clearfix">
	   <h3><a href="index.html"><span>M</span>STORE</a></h3>
	 </div>
	</div>
	<div class="col-sm-7">
	  ...
	  <div class="col-sm-8 space_left header_middle_1_middle_inner">
	                     <div id="custom-search-input">
                            <div class="input-group col-sm-12">
                                <input type="text" class="  search-query form-control" placeholder="Enter Product">
	...
	<nav class="navbar navbar-default cd-secondary-nav">
			<div class="container-fluid">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand" href="index.html"> <span>M</span>STORE </a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							<a class="menu_tab" href="index.html">Home</a></li>
						 
						<li>
							<a class="menu_tab" href="product.html">Product</a></li>
						
						<li>
							<a class="menu_tab active_tag" href="detail.html">Detail</a>  </li>
						
						<li>
							<a class="menu_tab" href="about.html">About Us</a>  </li>
							
						<li>
							<a class="menu_tab" href="contact.html">Contact</a> </li>
							
						<li>
							<a class="menu_tab" href="login.html">Login</a></li>
							
						
						<li class="dropdown mega-dropdown">
					<a href="#" class="dropdown-toggle menu_tab menu_tab_1" data-toggle="dropdown">More <span class="glyphicon glyphicon-chevron-down pull-right icon_1"></span></a>
	   ...
	   <div class="center_product_1 clearfix">
		<div class="col-sm-6">
		 <div class="center_product_1_left clearfix">
		   <h4>SAGITTIS IPSUM PRAESENT MAURIS</h4>
		 </div>
		</div>
		<div class="col-sm-6">
		 <div class="center_product_1_right text-right clearfix">
		  <ul>
		   ...
		   <li>Sagittis ipsum praesent mauris <i class="fa fa-caret-right"></i></li>
		  </ul>
		 </div>
		</div>
	   </div>
		  ...
		  <div class="product_page_left_2_inner clearfix">
		   ...
		   <div class="col-sm-8 space_left">
			<div class="product_page_left_2_inner_right clearfix">
			 ...
			 <p><a href="#">Cursus ante dapibus diam...</a></p>
		...
		<div class="product_detail_right clearfix">
		  <div class="product_detail_right_1 clearfix">
		   <div class="col-sm-6">
			<div class="product_detail_right_1_left clearfix">
			  ...
			  <div class="carousel-inner cont-slider">
				...
				<div class="item">
				  <div class="mag">
					<div class="magnify"><div class="magnify"><img data-toggle="magnify" src="img/30.jpg"  alt=""><div class="magnify-large" style="background: url(&quot;img/53.jpg&quot;) no-repeat;"></div></div><div class="magnify-large"></div></div>
				</div>
				</div>
				<div class="item">
				  <div class="mag">
					<div class="magnify"><div class="magnify"><img data-toggle="magnify" src="img/31.jpg"  alt=""><div class="magnify-large" style="background: url(&quot;img/54.jpg&quot;) no-repeat;"></div></div><div class="magnify-large"></div></div>
				</div>
				</div>
				<div class="item">
				  <div class="mag">
					<div class="magnify"><div class="magnify"><img data-toggle="magnify" src="img/32.jpg"  alt=""><div class="magnify-large" style="background: url(&quot;img/55.jpg&quot;) no-repeat;"></div></div><div class="magnify-large"></div></div>
				</div>
				</div>
				<div class="item active">
				  <div class="mag">
					<div class="magnify"><div class="magnify"><img data-toggle="magnify" src="img/33.jpg"  alt=""><div class="magnify-large" style="background: url(&quot;img/56.jpg&quot;) -101px -21px no-repeat; display: block; left: 17px; top: -27.5px; opacity: 0;"></div></div><div class="magnify-large"></div></div>
				</div>
				</div>
			  </div>
			  <!-- Indicators -->
		   ...
		   <div class="col-sm-6">
			...
			<h4><a href="#">Sagittis ipsum praesent mauris</a></h4>
			<h5><a href="#">
			  <i class="fa fa-star-o"></i>
			  <i class="fa fa-star-o"></i>
			  <i class="fa fa-star-o"></i>
			 ...
			 <ul>
			   <li><a class="tag_3" href="#"><i class="fa fa-shopping-cart"></i> Add To Wishlist</a></li>
			   <li><a class="tag_4" href="#"><i class="fa fa-heart-o"></i></a></li>
			   <li><a class="tag_4" href="#"><i class="fa fa-share"></i></a></li>
			 </ul>
		   </div>
			</div>
		   </div>
		  ...
		  <div class="product_detail_right_2 clearfix">
					...
					<ul class="nav nav-tabs">
					  ...
					  <li class=""><a data-toggle="tab" href="#menu1">MORE DETAILS</a></li>
					  <li><a data-toggle="tab" href="#menu2">COMMENTS</a></li>
					  <li><a data-toggle="tab" href="#menu3"> TRADITION SECTION</a></li>
				   </ul>
					...
					<div class="tab-content clearfix">
					  ...
					  <div id="menu1" class="tab-pane fade clearfix">
						 <div class="click clearfix">
						  <ul>
						   <li>Maker <span>Cursus  & Dapibus</span></li>
						   <li>Fabric <span>Imperdiet</span></li>
						  </ul>
					   </div>
					  </div>
					  <div id="menu2" class="tab-pane fade clearfix">
						 <div class="click clearfix">
						  ...
						  <h3 class="heading_tag">Sagittis ipsum praesent mauris</h3>
						  <h5>User Rating <span>*</span></h5>
						  <h5>
						  Caliber:
	...
	<div class="col-sm-4">
	 <div class="footer_1_inner clearfix">
	  ...
	  <ul class="footer_dropdown">
	   <li>40, 27th Street, Elementum Imperdiet, DB 05231, United Kingdom.</li>
