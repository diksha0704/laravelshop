			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							<a class="menu_tab active_tag" href="product.html">Product</a></li>
	   ...
	   <div class="center_product_1 clearfix">
		...
		<div class="col-sm-6">
		 <div class="center_product_1_right text-right clearfix">
		  <ul>
		   <li><a href="detail.html">Home <i class="fa fa-caret-right"></i></a></li>
   ...
   <div class="col-sm-9">
    <div class="product_page_right clearfix">
	 ...
	 <div class="product_page_right_2 clearfix">
	  ...
	  <div class="col-sm-9">
	   <div class="product_page_right_2_right clearfix">
	    <h4><a href="detail.html">Consectetur adipiscing elit</a></h4>
		<h5><a href="detail.html">
		 ...
		 <ul>
		   <li><a class="tag_3" href="detail.html"><i class="fa fa-shopping-cart"></i> Add To Wishlist</a></li>
	 ...
	 <div class="product_page_right_2 clearfix">
	  ...
	  <div class="col-sm-9">
	   <div class="product_page_right_2_right clearfix">
	    <h4><a href="detail.html">At nibh elementum imperdiet</a></h4>
		<h5><a href="detail.html">
		  <i class="fa fa-star-o"></i>
		  <i class="fa fa-star-o"></i>
		  <i class="fa fa-star-o"></i>
	 ...
	 <div class="product_page_right_2 clearfix">
	  <div class="col-sm-3 space_left">
	   <div class="product_page_right_2_left clearfix">
	    <a href="detail.html"><img src="img/12.png" width="100%" height="230px"></a>
	   </div>
	  </div>
	  <div class="col-sm-9">
	   <div class="product_page_right_2_right clearfix">
	    <h4><a href="detail.html">Sagittis ipsum praesent mauris</a></h4>
		<h5><a href="detail.html">
		  <i class="fa fa-star-o"></i>
		  <i class="fa fa-star-o"></i>
		  <i class="fa fa-star-o"></i>
	 ...
	 <div class="product_page_right_2 clearfix">
	  <div class="col-sm-3 space_left">
	   <div class="product_page_right_2_left clearfix">
	    <a href="detail.html"><img src="img/9.png" width="100%" height="230px"></a>
	   </div>
	  </div>
	  <div class="col-sm-9">
	   <div class="product_page_right_2_right clearfix">
	    <h4><a href="detail.html"> Sed augue semper porta</a></h4>
		<h5><a href="detail.html">
		  <i class="fa fa-star-o"></i>
		  <i class="fa fa-star-o"></i>
		  <i class="fa fa-star-o"></i>
